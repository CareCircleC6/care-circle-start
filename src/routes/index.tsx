  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 w-full z-40 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="max-w-6xl mx-auto px-6 pt-4 pb-3 md:h-20 md:pt-4 md:pb-0 flex flex-col md:flex-row items-center md:justify-between gap-5 md:gap-0">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <a href="https://myequityholdings.com" target="_blank" rel="noopener noreferrer" className="flex-1 md:flex-none text-sm font-medium text-[#1B365D] hover:underline"class="inline-flex items-center gap-1">Investor Login <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a>
          </div>
        </div>
      </nav>
