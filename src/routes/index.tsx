...
const steps = [
  { num: "01", title: "On-board", desc: "Sign up and add your medical records — prescriptions, lab results, imaging, doctor notes, or even voice memos. Everything in one secure place from day one." },
      ...
      <nav className="fixed top-0 w-full z-40 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold leading-tight" style={{ fontFamily: "var(--font-display)" }}>
