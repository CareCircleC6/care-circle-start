...
const steps = [
  ...
  { num: "02", title: "Organize", desc: "Get one current, up-to-date health care view." },
  { num: "03", title: "Auto-Monitor", desc: "Missed appointments, missed meds, drug interactions, missed tests, and care gaps are flagged automatically" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 w-full z-40 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <span className="text-xl font-bold text-primary ml-2" style={{ fontFamily: "var(--font-display)" }}>Care Circle Global</span>
