...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CareCircle — Care Coordination Made Simple" },
      ...
      { property: "og:title", content: "CareCircle — Care Coordination Made Simple" },
      ...
      { name: "twitter:title", content: "CareCircle — Care Coordination Made Simple" },
